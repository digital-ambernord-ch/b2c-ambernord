...
window.initLanding = async function () {
  ...
  mm.add('(min-width: 992px)', function () {
    ...
    const cards   = section ? Array.from(section.querySelectorAll('.huge-horizontal-bottle')) : [];
  ...
  mm.add('(max-width: 991px)', function () {
    ...
    var cards     = section ? Array.from(section.querySelectorAll('.huge-horizontal-bottle')) : [];
